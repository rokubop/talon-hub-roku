...
| **Tags** | ui |
| **License** | MIT |
| **Contributes** | 33 actions, 8 settings, 2 tags, 1 captures |
...
- `user.ui_elements_scroll_action`
...
![Version](https://img.shields.io/badge/version-1.2.0-blue) ![Status](https://img.shields.io/badge/status-stable-green) ![GitHub stars](https://img.shields.io/github/stars/rokubop/talon-input-map?style=social)
